...
<p align="center">
  <img width="700" src="https://github.com/user-attachments/assets/b9800fab-b523-48dc-b683-6ccf70d1fff1" alt="image1" width="45%"> <br><br>
</p>

<br>

### 2. " Deepracer-for-cloud\data\minio\bucket\DR_LOCAL_S3_MODEL_PREFIX " 경로의 " model.tar.gz " 파일을 deepracer console을 이용해 탑재해야 합니다.
- deepracer-for-cloud\data\minio\bucket\rl-deepracer-sagemaker\output 에 
아래의 사진을 참고해 명령어를 입력해주세요!<br>
```sh
...
<br>
위쪽 사진은 model.tar.gz가 output 파일에 있으신 경우, 아래쪽 사진은 rl-deepracer-sagemaker에 존재하는 경우입니다! <br>
<br>
<p align="center">
