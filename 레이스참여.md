...
<p align=center>
  <img width="409" alt="스크린샷 2024-07-31 오후 4 57 13" src="https://github.com/user-attachments/assets/4633ddc3-c61d-4960-85cc-826f335e1b56">
</p>
...
* 우분투 터미널 (deepracer-for-cloud 폴더)에서 AWS 액세스키 확인 <br>
  ```sh
  cat ~/.aws configure
  ```
  <p align=center>
...
*** 우분투 터미널 (deepracer-for-cloud 폴더)에서 AWS 액세스키 확인 및 설정하기 
  * aws configure 명령어를 통해 credential 검증 <br>**
    ...
    엔터
    <p align=center>
      <img width="674" alt="스크린샷 2024-07-31 오후 5 17 37" src="https://github.com/user-attachments/assets/8357d30f-7e74-427f-8814-bc5e3a6122e8">
    </p>
  * AWS 액세스키 확인
    ```sh
      cat ~/.aws configure
    ...
    <p align=center>
      <img width="1073" alt="스크린샷 2024-07-31 오후 5 24 57" src="https://github.com/user-attachments/assets/8b87de87-5515-448a-a132-0f6bfccef9df">
    </p>
...
* deepracer-for-cloud 경로에서 ls 입력
  ...
  * Run.env (또는 run.env) 파일 존재 확인
    <p align=center>
      <img width="100" alt="스크린샷 2024-07-31 오후 5 25 58" src="https://github.com/user-attachments/assets/7cb95025-a50d-46d5-b229-cf96d6308ea5">
    </p>
...
* 로컬 환경의 rl-deepracer-sagemaker 모델의 학습결과물이 S3 버킷의 spgtestjiyun 폴더에 rl-deepracer-sagemaker-1로 저장 됨
  <p align=center>
      <img width="1000" src="https://github.com/user-attachments/assets/1a95183d-a7db-4609-ae12-dd23a0441619">
  </p>
...
* AWS DeepRacer – Your models – Import model
  <p align=center>
    ...
    <br>
    <img width="800" src="https://github.com/user-attachments/assets/e703da17-b4e1-4ade-9ce2-e773d95f372a">
  </p>
