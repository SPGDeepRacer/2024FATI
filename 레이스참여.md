...
* **버킷 이름만 설정하여 생성 (다른 옵션은 기본설정)**
  <p align=center>
    <img width="350" alt="스크린샷 2024-07-27 오후 5 21 02" src="https://github.com/user-attachments/assets/c147b95f-ce41-4f2c-af2a-ebf2a0b5c0e9">
    <p> </p>
    ...
    <p>다른 옵션은 기본설정, 화면 맨 아래에 버킷 생성하면 내가 설정한 이름으로 버킷이 생긴다</p>
...
* **dr-upload-model 명령어 입력**
  ...
  * 만약 모델 학습 후 우분투 창을 꺼서, 재 접속 했다면
    * deepracer-for-cloud 경로에서 아래 명령어 입력 후, dr-upload-model 진행
      ...
      ```
      <p align=center>
        <img src="https://github.com/user-attachments/assets/1e3b6329-f064-4e99-a032-52c7aeb8748b">
      </p>
...
* **AWS DeepRacer – Your models – Import model**
  <p align=center>
    <img width="1000" src="https://github.com/user-attachments/assets/ae61f2ec-b4d9-4bd9-b71d-88bd3a179597">
    <br>
