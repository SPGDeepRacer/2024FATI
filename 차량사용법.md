...
- 차량의 구성품 (주로 사용하는 것만) <br>
  ...
  - 참고 : 모터 배터리 충전 방법 : 흰색 부분을 꽂기
   <p align="center">
      <img width="800" alt="스크린샷 2024-09-21 오전 2 05 45" src="https://github.com/user-attachments/assets/c547eb93-7709-47e6-90d6-1542d5e4f9ec">
   </p>
  
  - 아래 이미지처럼 짧은 C2C 케이블로 보조배리와 컴퓨팅 모델을 연결하고, 모터 배터리를 빨간 부분과 검은 부분 연결하여 DeepRacer On <br>
    모터 배터리를 연결했을 때 삑삑 소리가 나야 정상이다.
    <p align="center">
      <img width="700" alt="스크린샷 2024-09-21 오전 2 11 24" src="https://github.com/user-attachments/assets/ca3da9ce-65d9-45d1-b07b-bd23b1f365f7">
    </p>
  <br>
  <br>
...
- 해당 웹 페이지의 Control vehicle
  <p align="center">
    <img width="500" alt="image" src="https://github.com/user-attachments/assets/d9a9602b-3ca8-471b-aa29-d3a012e5199d">
  </p>
...
- Calibration - steering
  ...
  <div style="display: flex; align-items: center;">
    <div style="flex: 1;">
      <p>
        <b>1. 중앙 조향각 보정</b>  
        DeepRacer의 바퀴가 정면을 향할 수 있도록 조정한다.
      </p>
      <p>
        <b>2. 최대 왼쪽 조향각 보정</b>  
        잡음이 들리거나 바퀴가 왼쪽 방향으로 더 이상 돌아가지 않을 때까지 값을 올려서 조정한다.
      </p>
      <p>
        <b>3. 최대 오른쪽 조향각 보정</b>  
        잡음이 들리거나 바퀴가 오른쪽 방향으로 더 이상 돌아가지 않을 때까지 값을 올려서 조정한다.
      </p>
    </div>
    
    <div style="flex: 1;">
      <img width="100%" alt="image" src="https://github.com/user-attachments/assets/171db67b-5317-4caa-bfc8-781a57c3ae7e">
      <img width="100%" alt="image" src="https://github.com/user-attachments/assets/a4495662-988f-4e69-8fc4-396b99941ff0">
      <img width="100%" alt="image" src="https://github.com/user-attachments/assets/eed5b3f0-109f-46f9-ac66-799d3177bd46">
    </div>
