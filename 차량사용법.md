...
- Calibration – Speed <br>
  ...
  | **2. 차량의 순방향 설정** <br> 차량의 바퀴가 시계방향으로 돌면 순방향이 설정 된 것이다. 그렇지 않다면 Reverse direction을 체크한다.                             | ![이미지 2](https://github.com/user-attachments/assets/4ebdb3be-8ec5-4845-a68f-ae1371a8e59c) |
  | **3, 4. 최대 전진, 후진 속도 보정** <br> 훈련에서 사용한 최대 속도에서 20~30% 높게 양수 값(전진)으로 설정한다. 후진의 경우 음수 값으로 동일한 값을 설정한다. | ![이미지 3](https://github.com/user-attachments/assets/5a2f3c4d-5310-4415-b9d2-fd47446ebe0c) <br> ![이미지 4](https://github.com/user-attachments/assets/4a1d327d-b87e-44cd-8ec8-fb200c6f3ffa) |
