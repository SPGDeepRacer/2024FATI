...
- Calibration - steering <br>
  ...
  | 설명                                                                                              | 이미지                                                                                      |
  |--------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
  | **1. 중앙 조향각 보정** <br> DeepRacer의 바퀴가 정면을 향할 수 있도록 조정한다.                  | ![이미지 1](https://github.com/user-attachments/assets/171db67b-5317-4caa-bfc8-781a57c3ae7e) |
  | **2. 최대 왼쪽 조향각 보정** <br> 잡음이 들리거나 바퀴가 왼쪽 방향으로 더 이상 돌아가지 않을 때까지 값을 올려서 조정한다. | ![이미지 2](https://github.com/user-attachments/assets/a4495662-988f-4e69-8fc4-396b99941ff0) |
  | **3. 최대 오른쪽 조향각 보정** <br> 잡음이 들리거나 바퀴가 오른쪽 방향으로 더 이상 돌아가지 않을 때까지 값을 올려서 조정한다. | ![이미지 3](https://github.com/user-attachments/assets/eed5b3f0-109f-46f9-ac66-799d3177bd46) |
