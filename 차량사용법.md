...
- 차량의 구성품 (주로 사용하는 것만) <br>
  ...
  - 보조, 모터 배터리 충전 방법
   <p align="center">
      <img width="1200" alt="스크린샷 2024-09-21 오후 1 18 28" src="https://github.com/user-attachments/assets/f6c2ed68-7c8a-449d-a08f-886ed40f0c12">
   </p>

  
  - DeepRacer On <br>
    짧은 C2C 케이블로 보조배터리와 컴퓨팅 모델을 연결하고, 모터 배터리를 빨간 부분과 검은 부분 연결<br>
    모터 배터리를 연결했을 때 삑삑 소리가 나야 정상이다.
    <p align="center">
      <img width="1000" alt="스크린샷 2024-09-21 오후 1 18 38" src="https://github.com/user-attachments/assets/da1bd276-3f49-41c2-a2aa-57a6170f9b37">
